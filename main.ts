...
function Intro_til_rejse_3 () {
    ...
    story.spriteMoveToLocation(Prins, 170, 90, 5)
    pause(5000)
    pause(1000)
    ...
    pause(5000)
    story.printText("Den første udfordring Prins (xxx) stødte på var.... ", 0, 0)
    pause(5000)
}
...
function Mini_game_1 () {
    ...
    game.showLongText("Mini game 1", DialogLayout.Bottom)
}
function Del_5 () {
